...
<head>
    ...
    <link rel="stylesheet" href="../CSS_T/view_exam.css"> <!-- Nếu có file CSS riêng -->
        ...
        <?php if ($result_questions->num_rows > 0): ?>
            <?php while ($question = $result_questions->fetch_assoc()): ?>
                <div class="question">
                    ...
                    <p><strong>Chủ đề:</strong> <?php echo htmlspecialchars($question['topic']); ?></p>
                    <p><strong>Độ khó:</strong> <?php echo ucfirst($question['difficulty']); ?></p>
